...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import direct v7 JSONL judgments.")
    parser.add_argument("--candidates", required=True)
    parser.add_argument("--judgments", required=True)
    parser.add_argument("--output", required=True)
    parser.add_argument("--model", default="codex_current_gpt_direct")
    parser.add_argument("--run-id", default="codex_direct_reference_judge_v7")
    parser.add_argument("--provider", default="openai_codex_session")
    parser.add_argument("--prompt-id", default="shortform_reference_judge_v7_ko")
    parser.add_argument(
        "--input-modality",
    ...
    fields = [
        ...
        "repeat_index", "dry_run", "candidate_id", "verdict",
    ]
